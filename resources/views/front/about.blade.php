...
<!-- ======= Breadcrumbs ======= -->
<div class="breadcrumbs d-flex align-items-center" style="background-image: url('front_template/assets/img/breadcrumbs-bg.jpg');">
...
<section id="alt-services-2" class="alt-services section-bg">
  <div class="container" data-aos="fade-up">
    ...
    <div class="row justify-content-around gy-4">
      ...
      <div class="col-lg-6 img-bg" style="background-image: url(front_template/assets/img/alt-services-2.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>
    </div>
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="row gy-5">
      ...
      <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="500">
        <div class="member-img">
          <img src="front_template/assets/img/team/team-5.jpg" class="img-fluid" alt="">
          <div class="social">
            <a href="#"><i class="bi bi-twitter"></i></a>
            <a href="#"><i class="bi bi-facebook"></i></a>
            <a href="#"><i class="bi bi-instagram"></i></a>
      ...
      <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="600">
        <div class="member-img">
          <img src="front_template/assets/img/team/team-6.jpg" class="img-fluid" alt="">
          <div class="social">
            <a href="#"><i class="bi bi-twitter"></i></a>
            <a href="#"><i class="bi bi-facebook"></i></a>
            <a href="#"><i class="bi bi-instagram"></i></a>
